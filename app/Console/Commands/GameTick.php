...
#[Signature('game:tick')]
#[Description('Advance the simulated world: clock out idle players, record world events and open their cases, place supply orders between companies, hand over stale cases, let NPCs work, deliver shipments, carry out due appointments and close the month')]
class GameTick extends Command
{
    public function handle(IdleShiftCloser $idleShifts, WorldEventGenerator $worldEvents, StaleCaseWatcher $deadlines, NpcCaseWorker $npcs, SupplyOrderGenerator $supplyOrders, NpcDispatcher $dispatchers, TourExecutor $tours, AppointmentExecutor $appointments, MonthClose $monthClose): int
    {
