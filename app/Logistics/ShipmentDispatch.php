...
class ShipmentDispatch
{
     ...
     */
    public function send(City $city, Branch $sender, Branch $recipient, string $templateSlug, array $attributes): ?Shipment
    {
        ...
        return DB::transaction(function () use ($carrier, $sender, $recipient, $template, $attributes): Shipment {
